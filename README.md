...
-  JavaScript: [Репозиторий сборка Gulp4](https://github.com/RuslanKlukvin/Testingfive) сайт: [с jquery](https://ruslanklukvin.github.io/Testingfive/)   
...
-  JavaScript: [Репозиторий проекта на React](https://github.com/RuslanKlukvin/Movie). Данные по API загружаются на страницу [Web-приложения](https://ruslanklukvin.github.io/Movie/)  
